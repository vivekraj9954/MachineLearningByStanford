...
% transform y into binary form Y
I = eye(num_labels);
...
Rexp = (lambda * (sum(sum(Theta1(:, 2:end).^2,2)) + sum(sum(Theta2(:, 2:end).^2 , 2))))/(2*m);
...
% claculate regularized gradient
